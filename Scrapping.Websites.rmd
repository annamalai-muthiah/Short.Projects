...
```{r step1, echo=TRUE, warning=FALSE, message=FALSE, tidy=TRUE, cache=TRUE, comment=" "}
...
```{r step2, echo=TRUE, warning=FALSE, message=FALSE, tidy=TRUE, cache=TRUE, comment=" "}
...
```{r step3, echo=TRUE, warning=FALSE, message=FALSE, tidy=TRUE, cache=TRUE, comment=" "}
# Step 3:Due to absence of data from CBIC Calendar, there was not much to do 
```

```{r step4, echo=TRUE, warning=FALSE, message=FALSE, tidy=TRUE, cache=TRUE, comment=" "}
...
```{r step5, echo=TRUE, warning=FALSE, message=FALSE, tidy=TRUE, cache=TRUE, comment=" "}
